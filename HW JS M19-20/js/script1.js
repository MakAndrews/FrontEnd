$(function(a) {
console.log('hello! This is HW 2 for JS Module19-20');
...
var dataJ = JSON.stringify(dataSource);
console.log(dataJ);
var dataObj = JSON.parse(dataJ);
console.log(dataObj);

//**************************** ЗАДАНИЕ 1
var skills = _.map(dataObj, 'skills'); //вытаскиваем в новый массив - из всей подэлементов передаваемого массива - значения по указанному ключу
console.log(skills);

var skillsList = _.flatten(skills);	//Извлекает, в виде массива, элементы из объектов, содержащихся в передаваемом массиве  
var skillsListUniq = _.uniq(skillsList);	//выбрасываем повтаряющиеся значения
console.log(skillsList);
console.log(skillsListUniq);

var skillsListUniqSorted = _.sortBy(skillsListUniq);	//сортируем массив
console.log(skillsListUniqSorted);	//выводим все скиллы по заданию №1

//**************************** ЗАДАНИЕ 2
var names = _.sortBy(dataObj, 'friends'); //сортируем весь массив по кол-ву друзей и возвращаем в новый массив
console.log(names);
var namesList = _.map(names, 'name');	//выбираем из отсортированного полного массива имена в новый массив = получаем список имен отсортированный по заданию №2
console.log(namesList);

//**************************** ЗАДАНИЕ 3
var friends = _.map(dataObj, 'friends');	//выбираем в массив всех друзей в виде объектов данных
console.log(friends);

var friendsList = _.flatten(friends);	//преобразовуем в массивы объекты передаваемого массива
console.log(friendsList);

var friendsListNames = _.map(friendsList, 'name');	//выбираем в новый массив только имена
console.log(friendsListNames);

var friendsListNamesUniq = _.uniq(friendsListNames);	//убираем повторящюихся друзей - получаем массив по заданию №3
console.log(friendsListNamesUniq);
